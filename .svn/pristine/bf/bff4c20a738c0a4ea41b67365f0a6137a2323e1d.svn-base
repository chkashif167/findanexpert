...
export class ProviderOutbox extends Component {
    ...
    constructor(props) {
        ...
        fetch(App.ApisBaseUrl + '/api/Email/getoutboxemails?email=' + providerEmail + '&authToken=' + providerAccesstoken +
            '&iscustomer=false&pageNumber=' + pageSize + '&pageSize=' + 15)
            .then(response => {
                console.log(response);
                localStorage.setItem('providerOutboxStatus', response.status);
    ...
    render() {
        if (localStorage.getItem('providerOutboxStatus') == '200') {
    ...
    ProviderOutbox(allMessages) {
        ...
        if (this.state.totalPages == '2') {
            var listItems = (<ul class="pagination">
                <li class="page-item"><a class="page-link" href={"/customer-bookings/?" + 'providerEmails=' + 'outbox' + '&page=' + 1}>1</a></li>
                <li class="page-item"><a class="page-link" href={"/customer-bookings/?" + 'providerEmails=' + 'outbox' + '&page=' + 2}>2</a></li>
            </ul>
            );
        }
        else if (this.state.totalPages == '3') {
            var listItems = (<ul class="pagination">
                <li class="page-item"><a class="page-link" href={"/customer-bookings/?" + 'providerEmails=' + 'outbox'}>1</a></li>
                <li class="page-item"><a class="page-link" href={"/customer-bookings/?" + 'providerEmails=' + 'outbox' + '&page=' + 2}>2</a></li>
                <li class="page-item"><a class="page-link" href={"/customer-bookings/?" + 'providerEmails=' + 'outbox' + '&page=' + 3}>3</a></li>
            </ul>
            );
        }
            ...
            var listItems = (<ul class="pagination">
                ...
                <li class="page-item"><a class="page-link" href={"/customer-bookings/?" + 'providerEmails=' + 'outbox' + '&page=' + 2}>2</a></li>
                <li class="page-item"><a class="page-link" href={"/customer-bookings/?" + 'providerEmails=' + 'outbox' + '&page=' + 3}>3</a></li>
                <li class="page-item"><a class="page-link" href={"/customer-bookings/?" + 'providerEmails=' + 'outbox' + '&page=' + 4}>4</a></li>
            </ul>
            );
        }
        else {
        ...
        return (
            ...
            <div className="list-group emails">
                {allMessages.map(inbx =>
                    <a href={'/sent-email-details?' + btoa(encodeURIComponent('subject=' + inbx.subject + '&from=' + inbx.from + '&body=' + inbx.body))} className="list-group-item list-group-item-action flex-column align-items-start" key={inbx.emailid}>
