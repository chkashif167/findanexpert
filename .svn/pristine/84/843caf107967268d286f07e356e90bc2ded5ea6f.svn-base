...
export class ProductThree extends Component {
    displayName = ProductThree.name
                    ...
                    <div className="container">
                        <div className="row section-padding">
                            ...
                            <div className="col-md-12">
                                <h3 className="section-title pb-2"><strong>Product Three</strong></h3>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <img src="https://images.unsplash.com/photo-1552074283-b2de7daab9ae?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80" width="100%" />
                                    </div>
                                </div>
                    ...
                    <div className="container-fluid">
                        <div className="row section-padding">
                            <div class="card card-image" style={bg}>
                                <div class="text-white text-center rgba-stylish-strong py-5 px-4" style={rgb}>
                                    <div class="py-5">
