                  ...
                  <div className="container">
                      <div className="row pb-4">
                          ...
                          <div className="col-md-12">
                              <h3 className="section-title"><strong>Expert help center</strong></h3>

                              <div className="topText">
                                  <h3 className="mt-0">What can we Help you with?</h3> 
                                  <p>You are important for our business, and we want to satisfy your expectations. 
                                    We want everything to go as smooth as possible and we are always here to help you.</p>

                                  <p>There are 3 ways to get in touch with us for any problem you are facing or any question you have.</p>
                                  <ul>
                                      <li>Chat with us our live chat allows you to speak with our customer representative
                                          who will try to answer your questions as quickly as possible.</li>
                                      <li>Email us simply email our customer services team and we will respond in real time.</li>
                                      <li>Ring us If you prefer speaking to our customer services team over the phone
                                          ring us and we will be more than happy to serve you. </li>
                                  </ul>

                                  <h4><strong>Contact:</strong></h4>
                                  <p><strong>Email: <a href="mailto:contact@findanexpert.net">conatct@findanexpert.net</a></strong></p>
                                  <p><strong>Phone: <a href="tel:+44 123 456 789">+44 123 456 789</a></strong></p>

                                  <p>Below is a list of our most popular questions.
                                      If you still cant find what you are looking for then please do not hesitate to contact us. </p>
