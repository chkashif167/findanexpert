...
export class ProviderReply extends Component {
    displayName = ProviderReply.name
        ...
        return (
            ...
            <form onSubmit={this.handleSubmit}>
                ...
                <div className="text-center mb-3">
                    <button type="submit" className="btn bg-black btn-block text-white z-depth-1a w-auto float-right">Send Your Reply</button>
                </div>
            </form>
        );
    }
