...
export class Profile extends Component {
  ...
  render() {
    ...
    if (profileImage != "IMAGE NOT AVAILABLE") {
      var imagePreview = (
        <img
          ...
          class="img-fluid z-depth-1 img-profile"
    ...
    if (localStorage.getItem("gender") == "na") {
      ...
      var customerGender = (
        <h5 className="card-text">
          <strong>{localStorage.getItem("gender")}</strong>
        </h5>
      );
    }
                  ...
                  <div className="row pt-5 pb-5">
                    <div className="col-md-3 text-center ml-auto mr-auto">
                      ...
                      <div class="profileLinks pt-5">
                        <a
                          class="btn btn-primary bg-black mr-4"
                          href="/edit-profile"
                          style={border}
                        >
                          Edit Profile
                    ...
                    <div className="col-md-6 pb-4">
                      <div className="card colored-card">
                        <div className="card-body">
                          ...
                          <h5 className="card-text">
                            <strong>{localStorage.getItem("mobile")}</strong>
                          </h5>
                        </div>
                      </div>
                    </div>
