...
export class AuthenticateCustomer extends Component {
  ...
  login(username, password) {
    ...
    return fetch(
      App.ApisBaseUrl + "/api/SignIn/authenticatecustomer",
      requestOptions
    )
      .then(response => {
            ...
            <form onSubmit={this.handleSubmit}>
              ...
              <div className="md-form pb-3">
                <p className="font-small blue-text d-flex justify-content-end">
                  <Link to="/forgot-password-link" className="blue-text">
                    Forgotten{" "}
                    <span className="blue-text ml-1">your Password?</span>
                  </Link>
                </p>
              </div>
