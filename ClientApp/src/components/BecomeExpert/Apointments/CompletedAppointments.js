...
export class ProviderCompletedAppointments extends Component {
  ...
  constructor(props) {
    ...
    fetch(
      App.ApisBaseUrl +
        "/api/Provider/getcompletedappointments?serviceProviderId=" +
        "&pageNumber=" +
        completedPageSize +
        "&pageSize=" +
        15 +
      ...
      .then(data => {
        this.setState({
          totalCompletedPages: data.appointmentlist,
          loading: false
        });
  ...
  render() {
    if (this.state.completedList != "") {
      ...
      return this.noCompletedBookings();
    }
  }
      ...
      var listItems = (
        <ul class="pagination">
          <li class="page-item">
            <a
              class="page-link"
              href={"/provider-profile/?" + "booking=" + "completed"}
            >
              1
            </a>
          </li>
          <li class="page-item">
            <a
              class="page-link"
              href={
                "/provider-profile/?" + "booking=" + "completed" + "&page=" + 2
              }
            >
              2
            </a>
        ...
        <ul class="pagination">
          ...
          <li class="page-item">
            <a
              class="page-link"
              href={
                "/provider-profile/?" + "booking=" + "completed" + "&page=" + 3
              }
            >
              3
            </a>
        ...
        <ul class="pagination">
          ...
          <li class="page-item">
            <a
              class="page-link"
              href={
                "/provider-profile/?" + "booking=" + "completed" + "&page=" + 4
              }
            >
              4
            </a>
    ...
    return (
      <div>
        <p className="text-center pt-5">
          You have no completed bookings right now
        </p>
      </div>
    );
  }
