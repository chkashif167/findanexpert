  ...
  confirmationCodeCall(confirmationcode) {
    ...
    .then (response => {
      ...
      if(response.message === "Invalid code") {
       ...
       else if(response.message === "Activation code invalid/expired. Please try with valid code!") {
        toastr["error"](
        ...
        <section className="section-padding">
          <div className="container">
            <div className="row pb-4 mb-5 pt-5">
              <div className="col-md-12 signinRegisterWrap confirmCodeWrapper mt-5 mb-5">
          ...
          <div className="md-form pb-3">
            <p className="font-small blue-text d-flex justify-content-end">
              ...
              <a href="/provider-resend-confirmation-code" className="blue-text ml-1">
                Resend Code
              </a>
            </p>
          </div>
