...
export class ContactUs extends Component {
  ...
  sendContactEmail(name, email, subject, message) {
    ...
    return fetch(App.ApisBaseUrl + "/api/Email/contactus_email", requestOptions)
      .then(response => {
  ...
  render() {
    ...
    document.getElementsByTagName("META")[2].content =
      "Our clinics offer relaxing, welcoming and comfortable environment. Find an Expert is a services provider that uses the aid of technology to connect service providers with customers.";
    document.getElementsByTagName("TITLE")[0].text =
      "Contact Us - Find an Expert";
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12">
                <h2 className="text-center font-weight-bolder pageTitle">
            ...
            <div className="row text-center pt-5 pb-5">
              ...
              <div className="col-md-4 col-xs-4">
                <a
                  href="mailto:contact@findanexpert.net"
            ...
            <div className="row">
              <div className="col-md-10 offset-md-1">
                <div className="p-5 shadow">
                  <h2 className="pb-5 font-weight-bolder text-center">
                  ...
                  <form onSubmit={this.handleSubmit}>
                    ...
                    <div className="form-group text-right">
                      <button
                        type="submit"
                        className="btn bg-orange text-white btnround"
                      >
                        Send Message
                      </button>
                    </div>
