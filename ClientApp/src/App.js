        ...
        if (currentLocation == '/special-pages/partner-with-expert' || currentLocation == '/customer-help') {
            ...
            var layoutContent = (<Layout>
                <Switch>
                    ...
                    <Route path='/provider-authentication' component={ProviderAuthentication} />
                    <Route path='/provider-confirm-account' component={ConfirmProvider} />
                    ...
                    <Route path='/provider-schedular' component={ProviderAllSchedules} />
                    ...
                    <Route path='/sent-email-details' component={ProviderSentEmailDetail} />
                    <Route path='/provider-appointments' component={ProviderAppointments} />
                    <Route path='/provider-booking-detail' component={ProviderAppointmentDetail} />
                    ...
                    <Route path='/21-Reasons-For-Hair-Loss-In-Women-And-How-To-Prevent-It' component={ReasonsForHairLoss} />
                    <Route path='/Causes-Of-Hair-Loss-In-Men-Hair-Loss-Treatments-Synonyms-And-Many-More' component={CausesOfHairHairLossMen} />
                    <Route path='/What-is-a-facial-and-why-you-should-go-for-it' component={WhatIsFacial} />
                    <Route path='/Six-Benefits-Of-Collagen-Supplements' component={CollagenSupplements} />
                    <Route path='/Things-to-know-about-Carboxytherapy' component={KnowAboutCarboxyTherapy} />
                    <Route path='/Swedish-Massage-Vs-Deep-Tissue-Massage' component={SwedishVsDeepTissue} />
                    <Route path='/Which-Type-of-Massage-Is-Right-For-You' component={TypeOfMassage} />
                    <Route path='/Things-You-Should-Know-Before-Gel-Nail-Extensions' component={GelNailExtensionse} />
                    <Route path='/How-Event-Management-Companies-Benefit-You' component={EventManagementCompanies} />
                    <Route path='/How-To-Find-The-Best-Digital-Marketing-Agency' component={BestDigitalMarketingAgency} />
                    <Route path='/Health-Benefits-And-Risks-Of-Hot-Stone-Massage' component={HotStoneMassage} />
                    <Route path='/Lymphatic-Drainage-Massage:-What-It-Is-And-How-To-Perform-It' component={LymphaticDrainageMassage} />
                    <Route path='/What-is-Collagen' component={WhatisCollagen} />
                    <Route path='/What-is-Balayage-and-what-makes-it-so-popular' component={WhatIsBalayage} />
                    <Route path='/Highlights-Vs-Balayage-Similarities-Differences-And-Which-Technique-To-Go-For' component={HighlightsVsBalayage} />
